...
export const BlobShape2: React.FC<{ className?: string }> = ({ className }) => (
  ...
  >
    <path
      fill="currentColor"
      d="M38.1,-63.7C49.8,-59.3,60.1,-50.8,68.7,-40.4C77.3,-30,84.2,-17.6,83.9,-5.3C83.5,7,75.9,19.2,67.2,30.3C58.5,41.4,48.7,51.4,37.6,58.8C26.5,66.2,14.1,71.1,1.1,69.2C-11.9,67.3,-25.5,58.6,-38.6,50C-51.7,41.4,-64.3,32.9,-70.7,21.3C-77.1,9.7,-77.3,-5,-72.5,-18.2C-67.7,-31.4,-57.9,-43.1,-46.9,-47.8C-35.9,-52.5,-23.7,-50.2,-12.3,-50.7C-0.9,-51.2,11.3,-54.5,26.4,-68.1"
      transform="translate(100 100)"
    />
  </svg>
);

export const DoodleUnderline: React.FC<{ className?: string }> = ({
  className,
}) => (
  <svg
    className={className}
  ...
  >
    <path
      d="M3 9C20 3 40 3 60 5C80 7 100 9 117 3"
      stroke="currentColor"
      strokeWidth="4"
      strokeLinecap="round"
    />
