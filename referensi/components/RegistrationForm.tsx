...
const RegistrationForm: React.FC = () => {
  return (
    <div id="register" className="w-full max-w-lg mx-auto bg-white p-8 md:p-10 rounded-3xl shadow-2xl border border-gray-100 relative overflow-hidden">
      ...
      <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
        ...
        <div>
          <label htmlFor="email" className="block text-sm font-medium text-gray-700 mb-1">Alamat Email Institusi</label>
          <input 
            type="email" 
            id="email" 
        ...
        <div>
          <label htmlFor="role" className="block text-sm font-medium text-gray-700 mb-1">Profesi Saat Ini</label>
          <select 
            id="role"
            className="w-full px-4 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-brand-purple focus:border-transparent transition-all outline-none bg-gray-50 focus:bg-white"
          >
        ...
        <div className="pt-2">
          <Button variant="primary" size="lg" className="w-full shadow-xl hover:shadow-2xl transform hover:-translate-y-1">
